...
<div class="container">
    ...
    enctype="multipart/form-data">
       ...
       <input type="text"  class="form-control form-control-sm" name="productname" placeholder="NameProduct" required>
       
        </div>
        <div class="form-group">
            <label>Price</label>
            <input type="number"  class="form-control form-control-sm" name="price" placeholder="Giá tiền" required>
         ...
         <div class="form-group">
            ...
            <option value="Old-product">Sản phẩm cũ</option>
            </select>
