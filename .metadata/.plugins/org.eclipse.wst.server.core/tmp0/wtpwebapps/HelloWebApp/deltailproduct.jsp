                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="product-inner">
                                    <h2 class="product-name"><%=b.getName()%></h2>
                                    <div class="product-inner-price">
                                        <ins><%=b.getPrice()%></ins> <del>$100.00</del>
                                    </div>    
                                    ...
                                    <form action="" class="cart">
                                        ...
                                        if("Old-product".equals(b.getCategory())){
                                        	%>
                                        	<a href="home" class="btn btn-primary">ContinueShop</a>
                                    ...
                                    <div class="product-inner-category">
                                        <p>Category: <a href=""><%=b.getCategory()%></a>. Tags: <a href="">awesome</a>, <a href="">best</a>, <a href="">sale</a>, <a href="">shoes</a>. </p>
                                    </div> 
