...
<%@ page import="com.cgm.hello_web_app.dao.UserDao" %>
        ...
        <div class="col-1">
            <div class="woocommerce-billing-fields">
                ...
                <p id="billing_first_name_field" class="form-row form-row-first validate-required">
                    ...
                    <input type="text" value="<%=u.getName()%>" placeholder="" id="billing_first_name" name="billing_first_name" class="input-text ">
                </p>
                ...
                <p id="billing_email_field" class="form-row form-row-first validate-required validate-email">
                    ...
                    <input type="text" value="<%=u.getEmail()%>" placeholder="" id="billing_email" name="billing_email" class="input-text ">
                </p>
...
</form> <!-- Closing form tag for the first form -->
