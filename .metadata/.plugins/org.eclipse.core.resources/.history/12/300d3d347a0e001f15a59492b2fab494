...
<link rel="icon" href="img/brand4.png" type="img/x-icon">
...
<!--[if lt IE 9]>
    ...
    <style>
    .search-form {
        flex-grow: 5; /* Cho phép thanh tìm kiếm mở rộng khi kéo ra */
    }
</style>
</head>
<body>
   ...
   <div class="site-branding-area">
    <div class="container p-3">
        <div class="row align-items-center">
            ...
            <div class="col-sm-6">
                <form class="form-inline my-2 my-lg-0 d-flex justify-content-end search-form">
        ...
        <div class="row">
            ...
            <div class="latest-product">
                    ...
                    <div class="product-carousel">
                        <c:forEach items="${productListrecent}" var="productrecent">
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="${productrecent.image}" alt="">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                        <a href="deltailproduct.jsp?bid=${productrecent.id}" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                        
                                    </div>
                                </div>
                                <h2><a href="single-product.html">${productrecent.name}</a></h2>
                                <div class="product-carousel-price">
                                    <p>${productrecent.category}</p>
                                    <ins>$ ${productrecent.price}</ins>
                                    
                                    <del>$100.00</del>
                                    <p>${productrecent.status}</p>
                                </div>
          ...
          <!--   Cũ -->
                <div class="latest-product">
                    <h2 class="section-title">Old Products</h2>
                    <div class="product-carousel">
                        <c:forEach items="${productOld}" var="productold">
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="${productold.image}" alt="">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                ...
                                <h2><a href="single-product.html">${productold.name}</a></h2>
                                <div class="product-carousel-price">
                                    <p>${productold.category}</p>
                                    <ins>$ ${productold.price}</ins>
                                    
                                    <del>$100.00</del>
                                    <p>${productold.status}</p>
                                </div>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="single-product-widget">
						<h2 class="product-wid-title">OldSellers</h2>
						<a href="oldproduct" class="wid-view-more">View All</a>
				...
				<div class="col-md-4">
					<div class="single-product-widget">
						...
						<a href="recentproduct" class="wid-view-more">View All</a>
						<div class="single-wid-product">
							<a href="single-product.html"><img
				...
				<div class="col-md-4">
					<div class="single-product-widget">
						...
						<a href="newproduct" class="wid-view-more">View All</a>
						<div class="single-wid-product">
							<a href="single-product.html"><img
								src="img/product-thumb-3.jpg" alt="" class="product-thumb"></a>
							<h2>
